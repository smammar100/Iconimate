...
// lands the tip right at that edge. The exact Phosphor arrow-fat-line-left, animated whole so
...
export const ArrowFatLineLeftIcon = forwardRef<IconHandle, IconProps>(function ArrowFatLineLeftIcon(
  { size = 28, style, ...props },
  ref,
) {

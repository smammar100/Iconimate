...
// Centerline: tail → quarter-bend (centered 128,200, r≈96) → shaft → tip (40,104).
...
// viewBox (the up-left tip sits near the frame's left edge).
const OVERSHOOT_SCALE = 0.16;

export const ArrowBendDoubleUpLeftIcon = forwardRef<IconHandle, IconProps>(
  function ArrowBendDoubleUpLeftIcon({ size = 28, style, ...props }, ref) {

...
//
// arrow-bend-down-right: tail enters top-left, bends down, points right.
const SPINE = "M32,56A96,96,0,0,0,128,152L204.69,152";
...
export const ArrowBendDownRightIcon = forwardRef<IconHandle, IconProps>(
  function ArrowBendDownRightIcon({ size = 28, style, ...props }, ref) {

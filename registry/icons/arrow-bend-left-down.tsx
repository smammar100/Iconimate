...
//
// arrow-bend-left-down: tail enters top-right, bends left, points down.
const SPINE = "M200,32A96,96,0,0,0,104,128L104,204.69";
...
export const ArrowBendLeftDownIcon = forwardRef<IconHandle, IconProps>(
  function ArrowBendLeftDownIcon({ size = 28, style, ...props }, ref) {

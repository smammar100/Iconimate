...
//
// arrow-bend-right-up: tail enters bottom-left, bends right, points up.
const SPINE = "M56,224A96,96,0,0,0,152,128L152,51.31";
...
export const ArrowBendRightUpIcon = forwardRef<IconHandle, IconProps>(
  function ArrowBendRightUpIcon({ size = 28, style, ...props }, ref) {

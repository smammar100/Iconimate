...
// back, the "≈" acknowledging a near-match. Phosphor "approximate equals" glyph
// (currentColor), split into the two waves so each can move on its own.
...
/** Back-out overshoot — spring-like snap as the lines spring apart. */
const OVERSHOOT = [0.34, 1.56, 0.64, 1] as const;

const nudgeTop: Variants = {
  normal: { y: 0, transition: RETURN_TRANSITION },
  animate: { y: [0, 7, 0], transition: { duration: 0.5, ease: OVERSHOOT } },
};

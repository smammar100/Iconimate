...
// SCROLL — the up-right arrow rides a wheel inside the static box: it fades in
// small behind, reaches full size at the centre, then shrinks and fades out ahead,
// looping in the pointing direction (up-right) — a continuous cycle. The arrow is
...
const ARROW =
  "M90.34,165.66a8,8,0,0,1,0-11.32L140.69,104H112a8,8,0,0,1,0-16h48a8,8,0,0,1,8,8v48a8,8,0,0,1-16,0V115.31l-50.34,50.35a8,8,0,0,1-11.32,0Z";
...
export const ArrowSquareUpRightIcon = forwardRef<IconHandle, IconProps>(function ArrowSquareUpRightIcon(
  { size = 28, style, ...props },
  ref,
) {

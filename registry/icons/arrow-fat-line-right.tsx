...
// lands the tip right at that edge. The exact Phosphor arrow-fat-line-right, animated whole so
...
export const ArrowFatLineRightIcon = forwardRef<IconHandle, IconProps>(function ArrowFatLineRightIcon(
  { size = 28, style, ...props },
  ref,
) {

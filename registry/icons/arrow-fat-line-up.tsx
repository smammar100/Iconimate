...
// lands the tip right at that edge. The exact Phosphor arrow-fat-line-up, animated whole so
...
export const ArrowFatLineUpIcon = forwardRef<IconHandle, IconProps>(function ArrowFatLineUpIcon(
  { size = 28, style, ...props },
  ref,
) {

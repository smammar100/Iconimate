...
// SCROLL — the down-right arrow rides a wheel inside the static box: it fades in
// small behind, reaches full size at the centre, then shrinks and fades out ahead,
// looping in the pointing direction (down-right) — a continuous cycle. The arrow is

...
// SCROLL — the down-arrow rides a wheel inside the static box: it fades in small at
// the top, reaches full size at the centre, then shrinks and fades out the bottom,
// looping downward — a continuous "downloading" cycle. The arrow is clipped to the
// box interior so it only ever shows inside the frame. Two exact Phosphor sub-paths
// (the rounded square + the inner arrow), animated whole so the artwork is pixel-identical.
const SQUARE =
...
export const ArrowSquareDownIcon = forwardRef<IconHandle, IconProps>(function ArrowSquareDownIcon(
  { size = 28, style, ...props },
  ref,
) {

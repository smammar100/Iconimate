...
//
// arrow-bend-left-up: tail enters bottom-right, bends left, points up.
const SPINE = "M200,224A96,96,0,0,1,104,128L104,51.31";
...
export const ArrowBendLeftUpIcon = forwardRef<IconHandle, IconProps>(
  function ArrowBendLeftUpIcon({ size = 28, style, ...props }, ref) {

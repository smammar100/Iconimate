...
export default function ArrowsClockwiseLabPage() {
  ...
  return (
    ...
    >
      <h1 style={{ fontSize: 22, fontWeight: 600, margin: 0 }}>Arrows Clockwise — animation candidates</h1>
      <p style={{ opacity: 0.55, fontSize: 14, marginTop: 8, marginBottom: 40, textAlign: "center", maxWidth: 640 }}>
        Five takes on the refresh/sync spin, each built on a Disney motion principle. &ldquo;Spin&rdquo; is the shipped

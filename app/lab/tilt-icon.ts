/**
 * Phosphor airplane-tilt glyph — a plane banked ~45°, nose to the upper-right.
 * ViewBox 0 0 256 256, fill="currentColor". Single path; the whole craft animates
 * as one body. Bounding box centre ≈ (124, 132) — the natural pivot for a spin.
 */
export const PLANE =
...
/** Bounding-box centre as a view-box fraction — pivot for spin / bank. */
export const PLANE_PIVOT = { x: 0.484, y: 0.516 };

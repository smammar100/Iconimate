/**
 * Phosphor "apple-logo" glyph — the apple silhouette plus the LEAF/stem at the top.
 * ViewBox 0 0 256 256, fill="currentColor". Split so the leaf can flick on its own.
 *   BODY — the apple outline (outer + inner subpaths form the ring).
 *   LEAF — the stem/leaf; flicks about where it meets the apple (≈0.51, 0.133).
 */
export const BODY =
...
export const APPLE_LOGO = `${BODY}${LEAF}`;

/**
 * Phosphor airplane-landing glyph. ViewBox 0 0 256 256, fill="currentColor".
 * Split into the descending aircraft and the runway line beneath it, so the plane
 * can fly its approach while the runway holds still as the ground reference.
 */
...
export const RUNWAY = "M256,216a8,8,0,0,1-8,8H104a8,8,0,0,1,0-16H248A8,8,0,0,1,256,216Z";

/** Aircraft centre of mass — pivot for pitch (flare) and bank (crosswind). */
export const PLANE_PIVOT = { x: 0.5, y: 0.45 };

/** Right end of the runway (under the nose) — origin for streaking it on rollout. */
export const RUNWAY_ORIGIN = { x: 0.95, y: 0.844 };

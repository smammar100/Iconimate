...
export default function ArrowsInSimpleLabPage() {
  ...
  return (
    ...
    >
      <h1 style={{ fontSize: 22, fontWeight: 600, margin: 0 }}>Arrows In Simple — animation candidates</h1>
      <p style={{ opacity: 0.55, fontSize: 14, marginTop: 8, marginBottom: 40, textAlign: "center", maxWidth: 640 }}>
        Five takes on the two-arrow minimize glyph, each built on a Disney motion principle. Hover, focus, or watch them

...
export const ICON_META: Record<string, IconMeta> = {
  ...
  "bell-simple-z": { motion: "zzz", glow: "#E34BA0" },
  "bell-slash": { motion: "silenced", glow: "#E34BA0" },
  "bell-z": { motion: "zzz", glow: "#E34BA0" },
  belt: { motion: "fasten", glow: "#B87333" },
  "bezier-curve": { motion: "swing", glow: "#5B8DEF" },
  ...
  "bluetooth-connected": { motion: "handshake", glow: "#0082FC" },
  "bluetooth-slash": { motion: "blocked", glow: "#0082FC" },
  "bluetooth-x": { motion: "chomp", glow: "#0082FC" },
  "bookmark-simple": { motion: "gust", glow: "#E4685D" },
  gear: { motion: "spin-down", glow: "#8A94A6" },
  globe: { motion: "turn", glow: "#3FA9D6" },
  list: { motion: "collapse", glow: "#6E8BD6" },
  house: { motion: "welcome", glow: "#F2A65A" },
  user: { motion: "glance", glow: "#7C9CF5" },
  "users-three": { motion: "wave", glow: "#7C9CF5" },
  envelope: { motion: "unfold", glow: "#E0B341" },
  phone: { motion: "ring", glow: "#3FBF7F" },
  "magnifying-glass": { motion: "hunt", glow: "#8B7FE8" },
  "map-pin": { motion: "plant", glow: "#EF5F7A" },
  heart: { motion: "beat", glow: "#C457E0" },
  star: { motion: "favourite", glow: "#E6C100" },
  "arrow-right": { motion: "travel", glow: "#2DD4BF" },
  acorn: { motion: "rock", glow: "#5CC24E" },
  trash: { motion: "tip in", glow: "#F0584F" },
  ...
  "amazon-logo": { motion: "draw", glow: "#FF9900" },
  ...
  "arrow-down": { motion: "travel", glow: "#2DD4BF" },
  "arrow-down-left": { motion: "travel", glow: "#2DD4BF" },
  "arrow-down-right": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-down": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-left": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-line-down": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-line-left": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-line-right": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-line-up": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-lines-down": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-lines-left": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-lines-right": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-lines-up": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-right": { motion: "travel", glow: "#2DD4BF" },
  "arrow-fat-up": { motion: "travel", glow: "#2DD4BF" },
  "arrow-left": { motion: "travel", glow: "#2DD4BF" },
  ...
  "arrow-up": { motion: "travel", glow: "#2DD4BF" },
  "arrow-up-left": { motion: "travel", glow: "#2DD4BF" },
  "arrow-up-right": { motion: "travel", glow: "#2DD4BF" },
  ...
  bathtub: { motion: "sprinkle", glow: "#38BDF8" },
  "battery-charging": { motion: "static", glow: "#FACC15" },
  "battery-charging-vertical": { motion: "static", glow: "#FACC15" },
  "battery-empty": { motion: "fault", glow: "#F87171" },
  "battery-full": { motion: "level up", glow: "#4ADE80" },
  "battery-high": { motion: "level up", glow: "#4ADE80" },
  "battery-low": { motion: "low alert", glow: "#FB923C" },
  "battery-medium": { motion: "level up", glow: "#A3E635" },
  "battery-plus": { motion: "add", glow: "#60A5FA" },
  "battery-plus-vertical": { motion: "add", glow: "#60A5FA" },
  "battery-vertical-empty": { motion: "fault", glow: "#F87171" },
  "battery-vertical-full": { motion: "level up", glow: "#4ADE80" },
  "battery-vertical-high": { motion: "level up", glow: "#4ADE80" },
  "battery-vertical-low": { motion: "low alert", glow: "#FB923C" },
  "battery-vertical-medium": { motion: "level up", glow: "#A3E635" },
  "battery-warning": { motion: "rattle", glow: "#FBBF24" },
  "battery-warning-vertical": { motion: "rattle", glow: "#FBBF24" },
  "beach-ball": { motion: "bounce & roll", glow: "#38BDF8" },
